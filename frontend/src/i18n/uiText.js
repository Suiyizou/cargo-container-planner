const uiText = {
  ...
  "result.optimizationEyebrow": { zh: "最优原因", en: "Optimization Reason" },
  "result.optimizationTitle": { zh: "按总参考运价优先排序", en: "Ranked by Total Reference Freight" },
  "result.optimizationBasis": { zh: "先确保可装、承载和偏载合规，再比较总运价；利用率只做辅助判断。", en: "Fit, payload, and balance are checked first; then total freight is compared. Utilization is secondary." },
  "result.optimizationBest": { zh: "当前推荐", en: "Current Recommendation" },
  "result.optimizationCompare": { zh: "对比方案", en: "Compared Plan" },
  "result.optimizationSaving": { zh: "较该方案节省 {amount}", en: "Saves {amount} versus this plan" },
  "result.optimizationNoSaving": { zh: "参考运价相近，按箱数和利用率继续排序", en: "Similar freight; box count and utilization decide the order" },
  "result.optimizationMixed": { zh: "混合策略", en: "Mixed Strategy" },
  "result.optimizationMixedDetail": { zh: "系统按每个货舱单独尝试更小且可装的箱型，不再强制全程使用同一箱型。", en: "Each hold is tested against the smallest feasible cheaper container instead of forcing one container type throughout." },
  "result.mixedPlan": { zh: "多箱型组合", en: "Mixed Container Plan" },
  "result.holdLabel": { zh: "第 {index} 货舱", en: "Hold {index}" },
  "result.holdDetail": { zh: "装入 {pieces} 件，参考运价 {freight}", en: "{pieces} pcs loaded, reference freight {freight}" },
  "result.visualLazyEyebrow": { zh: "3D 按需生成", en: "3D On Demand" },
  "result.visualLazyTitle": { zh: "已先展示推荐结果", en: "Recommendation Shown First" },
  "result.visualLazyDescription": { zh: "三维装箱视图较重，默认延迟加载；需要检查摆放时再生成当前方案视图。", en: "The 3D packing view is heavier, so it is loaded only when needed for placement review." },
  "result.load3d": { zh: "生成 3D 装箱视图", en: "Generate 3D Packing View" },
  "result.previewPlan": { zh: "方案", en: "Plan" },
  "result.previewBoxes": { zh: "箱数", en: "Boxes" },
  "result.previewFreight": { zh: "运价", en: "Freight" },
  "result.previewFill": { zh: "利用率", en: "Utilization" },
  ...
  "excel.reviewOriginalData": { zh: "原始数据", en: "Original Data" },
  "excel.reviewAgentSuggestion": { zh: "Agent 建议", en: "Agent Suggestion" },
  "excel.reviewSystemJudgement": { zh: "系统判断", en: "System Judgement" },
  "excel.reviewImportedCandidate": { zh: "当前导入候选", en: "Current Import Candidate" },
  "excel.reviewNoSuggestion": { zh: "暂无可结构化的 Agent 建议，请按原文自行确认。", en: "No structured Agent suggestion is available; review the source text manually." },
